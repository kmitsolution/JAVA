...
<ul>
  <li>To catch and provide specific treatment to a subset of existing Java exceptions.</li>
<li>Business logic exceptions: These are the exceptions related to business logic and workflow. It is useful for the application users or the developers to understand the exact problem.</li>
</ul>
